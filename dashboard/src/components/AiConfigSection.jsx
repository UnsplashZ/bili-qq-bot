        ...
        <div className="space-y-4">
            ...
            {isGroup && (!aiIsInherited || !ragIsInherited || !profileIsInherited) && (
                <button
                    onClick={onReset}
                    disabled={disabled}
                    className="w-full px-4 py-2 text-sm font-medium text-gray-300 bg-white/5 border border-white/10 rounded-lg hover:bg-white/10 disabled:opacity-50 disabled:cursor-not-allowed"
                >
                    重置为全局设置
                </button>
            )}
