...
function normalizeAgentConfig(rawConfig = getRawAgentConfig()) {
    ...
    social.planningMinScore = Math.min(1, Math.max(0, parseNumber(social.planningMinScore, DEFAULT_AGENT_CONFIG.social.planningMinScore)))
    social.topicAffinityMinScore = Math.min(1, Math.max(0, parseNumber(social.topicAffinityMinScore, DEFAULT_AGENT_CONFIG.social.topicAffinityMinScore)))
