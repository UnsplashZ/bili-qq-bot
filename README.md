...
| `/菜单` | 查看帮助菜单 | `/菜单` |
| `/订阅列表` | 查看本群订阅列表 | `/订阅列表` |
| `/账户关注列表` | 查看 Bot 登录账户的关注列表 | `/账户关注列表` |
...
| `/查看黑名单` | 查看本群/全局黑名单 | `/查看黑名单` |
| `/设置 帮助` | 查看详细管理面板 | `/设置 帮助` |
| `/设置 功能 <开\|关>` | 开启/关闭指定群的Bot权限 | `/设置 功能 关` |
| `/设置 关注同步 <开\|关>` | 同步 Bot 账户关注至本群订阅 | `/设置 关注同步 开` |
| `/设置 黑名单 <添加\|移除> [qq]` | 管理黑名单 | `/设置 黑名单 添加 123456` |
| `/设置 标签 <分类> <开\|关>` | 开启/关闭指定分类的标签显示 | `/设置 标签 动态 开` |
| `/设置 AI上下文 <条数>` | 设置 AI 上下文保留条数 | `/设置 AI上下文 10` |
