...
const levelResult = runLogger({ LOG_LEVEL: 'warn' })
...
const includeResult = runLogger({ LOG_LEVEL: 'info', LOG_CHANNELS: 'RPC,PY' })
...
const excludeResult = runLogger({ LOG_LEVEL: 'info', LOG_EXCLUDE_CHANNELS: 'HTTP' })
